...
<head>
    ...
    <title>Transaction Details - TouriStay</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Dear {{ $user->name }},</p>
            <p>Your booking has been successfully processed. Here are the details of your transaction:</p>
            ...
            <div class="transaction-details">
                ...
                <div class="detail-row">
                    <div>Date:</div>
                    <div>{{ Carbon\Carbon::parse($transaction->created_at)->format('M d, Y') }}</div>
                </div>
                <div class="detail-row">
                    <div>Status:</div>
                    <div style="color: #047857; font-weight: bold;">{{ $transaction->status }}</div>
                </div>
            </div> 
            <div class="detail-row">
                <div>Property:</div>
