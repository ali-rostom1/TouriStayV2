            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-bold text-gray-800">Les réservations</h2>
                    </div>
                            ...
                            <table class="min-w-full bg-white">
                                <thead>
                                    <tr class="bg-gray-100 text-gray-700 uppercase text-sm leading-normal">
                                        ...
                                        <th class="py-3 px-6 text-left">nom du propriétaire</th>
                                ...
                                <tbody class="text-gray-600 text-sm">
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td class="py-3 px-6 text-left">
                                            {{$reservation->listing->landlord->name}}
                                        </td>
                                        <td class="py-3 px-6 text-left">
                    ...
                    @else
                        <div class="bg-gray-50 rounded-lg p-8 text-center">
                            <div class="text-gray-500 mb-4">
                                ...
                                <h3 class="text-xl font-medium mb-2">Il n'y a pas des reservations</h3>
                            </div>
                        </div>
                    @endif
                </div>
